 ...
 */
@Data
public class LoginExpiredException extends BizException {
    ...
    public LoginExpiredException(String code, String msgFormat, Object... args) {
        super(MessageFormat.format(msgFormat, args));
        this.code = code;
        this.msg = MessageFormat.format(msgFormat, args);
    }

    public LoginExpiredException(EnumInterface enumInterface, Object... args) {
